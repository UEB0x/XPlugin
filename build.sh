...
${UE_PATH}${UAT_PATH}RunUAT.sh BuildPlugin -Plugin="${CURR_PATH}/Plugins/${UE_PLUGIN_NAME}.uplugin" -TargetPlatforms=Mac+IOS -Package="${CURR_PATH}/output"
